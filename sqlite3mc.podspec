...
s.default_subspecs = 'common'
  ...
  s.subspec 'common' do |ss|
    ...
    ss.osx.pod_target_xcconfig = { 'OTHER_CFLAGS' => '$(inherited) -DHAVE_USLEEP=1 -maes -isystem=./ -Wno-strict-prototypes -Wno-shorten-64-to-32 -Wno-ambiguous-macro -Wno-unused-variable -Wno-comma -Wno-unreachable-code',
